...
function moneda() {
    ...
    let resultado = (x/meses.length)/(moneda.cambio);
    ...
    if (resultado > p){
      ...
      swal({
        ...
        document.getElementById('input').innerHTML = "Usted debe ahorrar la suma de  Q " +parseInt(resultado) +" durante 12 meses " + "para alcanzar la suma de $" + x  + "." + "<br><br>"; 
      }
  ...
  let resultado = x / meses.length;
    ...
    sessionStorage.setItem("ahorro", JSON.stringify(x));
      ...
      if (x == false) {
        ...
        swal({
          title: "Error!",
          text: "El monto del ahorro debe ser mayor a Q1000!",
          icon: "warning",
          button: "OK",
        });
        return;
